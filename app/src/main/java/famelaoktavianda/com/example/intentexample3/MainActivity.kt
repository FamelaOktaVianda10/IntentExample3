package famelaoktavianda.com.example.intentexample3

import android.app.Activity
import android.content.Intent
import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import famelaoktavianda.com.example.intentexample3.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun getBMIDescription(bmi: Double): String { return when (bmi) {
